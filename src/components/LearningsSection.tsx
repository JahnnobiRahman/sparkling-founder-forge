...
const LearningsSection = () => {
  const learnings = [
    ...
    },
    {
      ...
      impact:
        "Unlocked access to 50M+ users; adoption grew ~40% and subscribers passed 78K+.",
      details:
    ...
    },
    {
      ...
      category: "Leadership",
      impact:
        "Raised capital (incl. $300K VC) and aligned cross-functional teams faster with clearer narratives.",
      details:
    ...
    },
    {
      ...
      category: "Growth",
      impact:
        "200K+ users, 78K+ subscribers, and 8.5 NPS supported by consistent lifecycle touchpoints.",
      details:
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="glass-card p-8 mt-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Great products start with human understanding, are refined through evidence, and scaled with discipline.
          </p>
        </Card>
      </div>
    </section>
